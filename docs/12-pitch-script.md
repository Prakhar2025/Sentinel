...
**1:30–3:00 — Live Demo**
- Analyst console: event comes in at Merchant 4 → verdict BLOCK_REC at 2.3 milliseconds median → drill into the evidence view: same device linked to 6 identities across 6 merchants, taint path from a confirmed chargeback, LLM narrative in one paragraph.
...
(From the real log, docs/what-broke.md, twenty entries.) Suggested picks:
