...
| P4 | Scope creep (dashboard over-investment) | Med | Med | Dashboard is P1 with hard 150-line budget; core API + evaluation are P0 |
| P5 | Codebase exceeds 3,000 lines | Med | Med | Line budget per module in roadmap; ruff + review discipline; dashboard stays single-file |
